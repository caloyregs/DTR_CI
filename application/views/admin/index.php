             ...
             <div class="col p-0">
               <div class="card shadow mb-4">
                 ...
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">Employees Shift</h6>
                 </div>
                 <!-- Card Body -->
             ...
             <div class="col p-0">
               <div class="card border-left-dark shadow h-100 py-2">
                 <div class="card-body">
                   <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">DEMO APP - ATTENDANCE</div>
                       <div class="h5 mb-0 font-weight-bold text-gray-800">CLOYD PAUYON </div>
                     </div>
                     <div class="col-auto">
